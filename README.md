...
Локальный ИИ-ассистент: **MP3 → транскрипт с говорящими → поручения с исполнителями и исходными сроками → DOCX**. Есть CLI и минимальная страница загрузки аудио. Аудио и текст не отправляются внешним облачным API.
