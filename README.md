...
- совещания №1/№2 из комплекта: найдены **все 10 из 10 и 6 из 6 строк эталонного протокола** с тем же ответственным и сроком, лишних поручений нет ([журнал сверки](docs/runs/1708-reference-match.log), сверка вручную);
...
| Совещание №2 (RU) | ru | — | 6/6 строк эталона; две разбиты на два поручения, итого 8 | 8/8 |
