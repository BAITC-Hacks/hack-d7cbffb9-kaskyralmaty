    ...
    if ($('with-tab').checked) {
      try {
        ...
        if (display.getAudioTracks().length) {
          ...
          tabNote = 'Внимание: звук собеседников не записывается, при выборе вкладки не отмечено «Поделиться звуком». Остановите и начните заново, если нужны все участники.';
        }
      } catch {
        tabNote = 'Внимание: доступ к вкладке или экрану не дан. Записывается только микрофон, голоса собеседников не попадут в протокол.';
      }
    }
